...
class Tblactionfieldoptionfilters
{
    ...
    /**
     * @var \Main\Entity\Tblactionfieldoptions
     *
     * @ORM\Id
     * @ORM\GeneratedValue(strategy="NONE")
     * @ORM\OneToOne(targetEntity="Main\Entity\Tblactionfieldoptions")
     * @ORM\JoinColumns({
     ...
     *
     * @param \Main\Entity\Tblactionfieldoptions $intactionfieldoptionid
     * @return Tblactionfieldoptionfilters
     */
    public function setIntactionfieldoptionid(\Main\Entity\Tblactionfieldoptions $intactionfieldoptionid)
    {
     ...
     *
     * @return \Main\Entity\Tblactionfieldoptions 
     */
