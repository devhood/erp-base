...
class Tblrealms
{
     ...
     * Set intrealmtypeid
     *
     * @param \Security\Entity\Tblrealmtypes $intrealmtypeid
     * @return Tblrealms
     */
    public function setIntrealmtypeid(\Security\Entity\Tblrealmtypes $intrealmtypeid = null)
    {
     ...
     * Get intrealmtypeid
     *
     * @return \Security\Entity\Tblrealmtypes 
     */
