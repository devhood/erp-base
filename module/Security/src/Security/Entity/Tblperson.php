...
class Tblperson
{
    ...
    /**
     * @var \Security\Entity\Tblpersontype
     *
     * @ORM\ManyToOne(targetEntity="Security\Entity\Tblpersontype")
     * @ORM\JoinColumns({
     ...
     * Set intpersontypeid
     *
     * @param \Security\Entity\Tblpersontype $intpersontypeid
     * @return Tblperson
     */
    public function setIntpersontypeid(\Security\Entity\Tblpersontype $intpersontypeid = null)
    {
     ...
     * Get intpersontypeid
     *
     * @return \Security\Entity\Tblpersontype 
     */
